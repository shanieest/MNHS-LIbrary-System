          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, users.user_id AS stud, borrow.status AS barstat FROM borrow LEFT JOIN users ON users.id=borrow.user_id LEFT JOIN books ON books.id=borrow.book_id ORDER BY date_borrow DESC";
